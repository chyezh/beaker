                ...
                Ok(Some((record_type, data))) => {
                    match record_type {
                        ...
                        RecordType::Full => {
                            ...
                            return Some(Ok(BytesMut::from(data)));
                        }
                        RecordType::First => {
...
impl<W: Write> RecordWriter<W> {
    ...
    pub fn append(&mut self, data: Bytes) -> Result<()> {
...
mod tests {
    ...
    #[test]
    fn test_log_read_writer_with_random_case() {
        use super::*;
    ...
    fn generate_random_bytes_vec(num: usize) -> Vec<Bytes> {
